...
public class DBRegPatient extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "RegPatient.db";
    private static final String TABLE_NAME = "RegPatient";
    private static final String COL_EMAIL = "Email";
    private static final String COL_PASSWORD = "Password";

    public DBRegPatient(Context context) {
